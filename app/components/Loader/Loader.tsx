...
const Loader: FC<LoaderProps> = ({
  primaryFillColor = "fill-pink-500",
  secondaryFillColor = "fill-pink-200",
  width = "w-6",
}) => {
  return (
    <svg
      aria-hidden="true"
      role="status"
      className={clsx(`mr-3 inline h-auto w-4 animate-spin text-white`, {
        [`${width}`]: width,
      })}
      viewBox="0 0 100 101"
      fill="none"
